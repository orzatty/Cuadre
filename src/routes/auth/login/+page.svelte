<script lang="ts">
  import { login, authError, isLoading, isAuthenticated } from '$lib/stores/auth';
  ...
  async function handleLogin() {
    ...
    if (success) {
      ...
      errorMsg = $authError || 'Credenciales incorrectas.';
    }
  }
</script>
...
<div class="auth-page">
  <div class="auth-card glass-card">
    <div class="brand-header">
      ...
      <p class="brand-tagline">Tus finanzas, en orden.</p>
    </div>
    ...
    <div class="auth-footer">
      <p class="footer-text">¿No tienes una cuenta?</p>
      <a href="/auth/register" class="footer-link">Registrarse aquí</a>
    </div>
  </div>
</div>
